...
select
    ...
    cast(monthly_spend.actual_spending as numeric(14, 2)) as actual_spending,
    monthly_spend.actual_spending > budgets.monthly_budget_ron as is_over_budget,
    cast(
        round(monthly_spend.actual_spending / budgets.monthly_budget_ron * 100, 1) as numeric(14, 2)
    ) as pct_of_budget
from monthly_spend
join budgets
